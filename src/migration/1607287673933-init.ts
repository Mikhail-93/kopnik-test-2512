...
export class init1607287673933 implements MigrationInterface {
  name = 'init1607287673933'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "vk_id" bigint NOT NULL, "rank" integer NOT NULL DEFAULT '1', "status" integer NOT NULL DEFAULT '0', "role" integer NOT NULL DEFAULT '5', "first_name" character varying NOT NULL, "last_name" character varying NOT NULL, "patronymic" character varying NOT NULL, "locale" character varying NOT NULL DEFAULT 'ru', "href" character varying NOT NULL, "photo" character varying NOT NULL, "birth_year" integer NOT NULL, "passport" character varying NOT NULL, "latitude" double precision NOT NULL DEFAULT '0', "longitude" double precision NOT NULL DEFAULT '0', "is_witness" boolean NOT NULL DEFAULT false, "witness_chat_invite_link" character varying, "witness_chat_id" integer, "ten_chat_invite_link" character varying, "ten_chat_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "foreman_id" integer, "foreman_request_id" integer, "witness_id" integer, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
